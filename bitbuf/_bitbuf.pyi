...
class bitbuf:
    ...
    def assign(self, value: InputTypes = 0, width: int = -1): ...
    ...
    def set_bits(self, pos: int, value: InputTypes, width: int = -1): ...
    def set_ones(self, pos: int, width: int): ...
    def set_zeros(self, pos: int, width: int): ...
    def toggle(self, pos: int = -1, width: int = -1): ...

    def lshift(self, bits: int): ...
    def rshift(self, bits: int): ...

    def append_low(self, value: InputTypes, width: int = -1): ...
    def append_high(self, value: InputTypes, width: int = -1): ...
    def delete_low(self, width: int): ...
    def delete_high(self, width: int): ...
