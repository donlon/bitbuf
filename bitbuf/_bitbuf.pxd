...
cdef class bitbuf:
    ...
    cpdef void assign(self, object value=*, int width=*)
    ...
    cpdef void set_bits(self, int pos, object value, int width=*)
    cpdef void set_ones(self, int pos, int width)
    cpdef void set_zeros(self, int pos, int width)
    cpdef void toggle(self, int pos=*, int width=*)
    cpdef void lshift(self, int bits)
    cpdef void rshift(self, int bits)
    cpdef void append_low(self, object value, int width=*)
    cpdef void append_high(self, object value, int width=*)
