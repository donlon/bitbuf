...
#define METH_FAST_KW (METH_FASTCALL | METH_KEYWORDS)
#define METH_CLASS_FAST_KW (METH_FASTCALL | METH_KEYWORDS | METH_CLASS)
...
static PyMethodDef PyBitBuf_methods[] = {
        ...
        {"from_buffer",           PYFUNC(PyBitBuf_from_buffer),           METH_CLASS_FAST_KW,  nullptr},
        /* Builtin methods */
        ...
        /* Class methods */
        {"assign",                PYFUNC(PyBitBuf_assign),                METH_FAST_KW,        nullptr},
        ...
        {"get_bits",              PYFUNC(PyBitBuf_get_bits),              METH_FAST_KW,        nullptr},
        {"get_bits_as_bytes",     PYFUNC(PyBitBuf_get_bits_as_bytes),     METH_FAST_KW,        nullptr},
        {"get_bits_as_bytearray", PYFUNC(PyBitBuf_get_bits_as_bytearray), METH_FAST_KW,        nullptr},
        {"slice",                 PYFUNC(PyBitBuf_slice),                 METH_FAST_KW,        nullptr},
        {"clear_bit",             PYFUNC(PyBitBuf_clear_bit),             METH_O,              nullptr},
        {"set_bit",               PYFUNC(PyBitBuf_set_bit),               METH_FAST_KW,        nullptr},
        {"set_bits",              PYFUNC(PyBitBuf_set_bits),              METH_FAST_KW,        nullptr},
        {"set_ones",              PYFUNC(PyBitBuf_set_ones),              METH_FAST_KW,        nullptr},
        {"set_zeros",             PYFUNC(PyBitBuf_set_zeros),             METH_FAST_KW,        nullptr},
        {"toggle",                PYFUNC(PyBitBuf_toggle),                METH_FAST_KW,        nullptr},
        {"lshift",                PYFUNC(PyBitBuf_lshift),                METH_O,              nullptr},
        {"rshift",                PYFUNC(PyBitBuf_rshift),                METH_O,              nullptr},
        {"append_low",            PYFUNC(PyBitBuf_append_low),            METH_FAST_KW,        nullptr},
        {"append_high",           PYFUNC(PyBitBuf_append_high),           METH_FAST_KW,        nullptr},
